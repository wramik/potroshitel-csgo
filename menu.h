...
public:
	void init( ) {
		...
		accuracy_boost.setup( XOR( "accuracy boost" ), XOR( "accuracy_boost" ) );
		accuracy_boost.AddShowCallback( callbacks::IsConfigMM );
		RegisterElement( &accuracy_boost, 1 );

		accuracy_boost_amount.setup( "", XOR( "accuracy_boost_amount" ), 1.f, 100.f, false, 0, 50.f, 1.f, XOR( L"%" ) );
		accuracy_boost_amount.AddShowCallback( callbacks::IsConfigMM );
		accuracy_boost_amount.AddShowCallback( callbacks::IsAccuracyBoostOn );
...
public:
	void init( ) {
		...
		lag_limit.setup( XOR( "limit" ), XOR( "lag_limit" ), 1, 16, true, 0, 2, 1.f );
...
public:
	void init( ) {
		...
		autostop.setup( XOR( "automatic stop" ), XOR( "auto_stop" ) );
		RegisterElement( &autostop );

		/*autostop.setup( XOR( "automatic stop" ), XOR( "auto_stop" ), { XOR( "none" ), XOR( "on lethal" ), XOR( "hitchance fail" ),  XOR( "always" ) } );
		RegisterElement( &autostop, 1 );*/

		autostop_method.setup( XOR( "automatic stop method" ), XOR( "auto_stop_method" ), { XOR( "adaptive" ), XOR( "between shots" ), XOR( "full stop" ) } );
		RegisterElement( &autostop_method, 1 );
