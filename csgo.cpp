...
bool CSGO::init( ) {
	...
	LookupBone                      = pattern::find( m_client_dll, XOR( "55 8B EC 53 56 8B F1 57 83 BE ? ? ? ? ? 75 14 8B 46 04 8D 4E 04 FF 50 20 85 C0 74 07 8B CE E8 ? ? ? ? 8B 8E ? ? ? ? 85 C9 0F 84" ) ).as< LookupBone_t >( );
